...
const PATHS = {
  ...
  globe: 'M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18zM3 12h18M12 3c2.4 2.5 3.8 5.5 3.8 9s-1.4 6.5-3.8 9c-2.4-2.5-3.8-5.5-3.8-9s1.4-6.5 3.8-9z',
 ...
 * бейджи Pro и админа/модератора рядом с именем в профиле (и везде, где
 * профиль отображается — посты, уведомления и т.д.). Если картинка не
 * загрузится — честный откат на прежний нарисованный глиф.
 */
const CUSTOM_ICON_URLS = {
  verified: 'https://cdn-icons-png.flaticon.com/128/1828/1828640.png',
  shield: 'https://cdn-icons-png.flaticon.com/128/1831/1831356.png',
};
